...
unsigned long render::fonts::cs_font;
unsigned long render::fonts::indi_font;
unsigned long render::fonts::indi2_font;
unsigned long render::fonts::small_font;
// strayfade suggestion TODO: for CLIENT INFO red/green make outline with 150.f alpha for text
void render::initialize() {
	render::fonts::watermark_font = interfaces::surface->font_create();
	render::fonts::gui_font = interfaces::surface->font_create();
	render::fonts::cs_font = interfaces::surface->font_create();
	render::fonts::indi_font = interfaces::surface->font_create();
	render::fonts::indi2_font = interfaces::surface->font_create();
	...
	interfaces::surface->set_font_glyph(render::fonts::cs_font, "Counter-Strike", 28, 500, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::indi_font, "Verdana", 26, 500, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::indi2_font, "Verdana", 12, 500, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::small_font, "Small Fonts", 8, 500, 0, 0, font_flags::fontflag_outline);
