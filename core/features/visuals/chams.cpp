...
void visuals::chams::dme_misc(hooks::dme::fn original, void* thisptr, void* context, void* state, const model_render_info_t& info, matrix_t* custom_bone_to_world)
{
	...
	if (is_sleeves && variables::sleeve_chams)
	{
	...
	else if (is_arms && variables::arms_chams)
	{
	...
	else if (is_weapon && variables::weapon_chams && !is_arms && !is_sleeves && !is_fists) // TODO: fix (exclude arms from this) // yeahhhh....... no. (im retarded)
	{
