...
public:
	...
	vec2_t& get_abs_origin()
	{
		using original_fn = vec2_t & (__thiscall*)(PVOID);
		return utilities::call_virtual<original_fn>(this, 10)(this);
	}
...
public:
	...
	bool is_non_aim() {
		return this->is_c4() || this->is_knife() || this->is_nade() || this->clip1_count() == 0;
	}
...
public:
	...
	void update_state(anim_state* state, vec3_t ang) {
		...
		static auto ret = reinterpret_cast<fn>(utilities::pattern_scan(xorstr_("client.dll"), xorstr_("55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 F3 0F 11 54 24")));
	...
	void set_abs_angles(vec3_t angles)
	{
		...
		static fn abs_angles = (fn)(utilities::pattern_scan(xorstr_("client.dll"), xorstr_("55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8")));
	...
	void create_state(anim_state* state) {
		...
		static auto ret = (fn)utilities::pattern_scan(xorstr_("client.dll"), xorstr_("55 8B EC 56 8B F1 B9 ? ? ? ? C7 46")); //55 8B EC 56 8B F1 B9 ? ? ? ? C7 46
		if (!ret)
			return;
